...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#EDEDED]">
      ...
      {/* Registration Modal */}
      {showRegister && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4" data-testid="registration-modal">
          <motion.div
